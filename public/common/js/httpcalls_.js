    ...
    return a = $.extend({
        ...
        execute: function () {
            ...
            if(a.triggeredElement!=null && a.triggeredElement.nodeType == Node.ELEMENT_NODE) {
                ...
                a.loader = $('<div class="loader8" style="width:'+width+'px;margin:0;margin-top:-2px;position: '+position+';left:'+offset.left+'px;top:'+(height+offset.top)+'px"> </div>')
            ...
            a.ajax.done(function (response) {if(a.doneCallback!=null) a.doneCallback(response);return a })
            ...
            a.ajax.always(function() {a.resquesIsRunning=false; if(a.alwaysCallback!=null)a.alwaysCallback();if(a.loader!=null)a.loader.remove();if(a.triggeredElement!=null && a.triggeredElement.nodeType == Node.ELEMENT_NODE) $(a.triggeredElement).removeClass('not-clickable');return a;  });
