$.extend({
	...
	*/
	toast: function(obj) {
		...
		if(flag) {
			var content = "<div id='toast-div' style='position: fixed;display: none; z-index:22999;font-size: 12px; " + position + ";left: 0;width:100%; height: " + height + "; text-align: center'>";
		} else {
			var content = "<div id='toast-div' style='position: fixed; display: none;z-index:22999; top: 0; left: 0;width:100%; height:100%; text-align: center'>";
		}
